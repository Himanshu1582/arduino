...
int app1 = 12; //appliance 1
int app2 = 13;
int app3 = 14;//appliance 2`
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>HIMANSHU RANA ROOM</h1>");
            
            // Display current state, and ON/OFF buttons for GPIO 5  
            client.println("<p>app1 - State " + app1state + "</p>");
            // If Appliance 1 is off, it displays the ON button       
            if (app1state == "off") {
              client.println("<p><a href=\"/app1/off\"><button class=\"button\">off</button></a></p>");
            } else {
              client.println("<p><a href=\"/app1/on\"><button class=\"button button2\">on</button></a></p>");
            } 
            ...
            // If Appliance 1 is off, it displays the ON button       
            if (app3state == "off") {
              client.println("<p><a href=\"/app3/off\"><button class=\"button\">off</button></a></p>");
            } else {
              client.println("<p><a href=\"/app3/on\"><button class=\"button button2\">on</button></a></p>");
            } 
