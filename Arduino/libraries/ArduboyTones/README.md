...
ArduboyTones will work with the Arduboy DevKit. The DevKit is limited to controlling only one pin for the speaker, so all tones will sound at normalUSBCðÀß      
*  úp         mp                      ( H p         3       3      €   H                 ÿ