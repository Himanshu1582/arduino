...
/// @param[in] degrees The temperature setting in degrees.
/// @param[in] fan The speed setting for the fan.
/// @param[in] swingv The vertical swing settUSBC`ÅSß     
*  û5  €       *ailable.
  // No Sleep setting available.
  // No Clock setting available.
  ac->send();
...
/// @param[in] degrees The temperature setting in degrees.
/// @param[in] fan The speed setting for the fan.
/// @param[in] swingv The vertical swing sett                           const bool on, const stdAc::opmode_t mode,
                              const float degrees,
                              const stdAc::fanspeed_t fan,
                              const stdAc::swingv_t swingv,
                              const stdAc::swingh_t swingh,
...
int16_t IRac::strToModel(const char *str, const int16_t def) {
  ...
  // Haier models
    ...
    return haier_ac176_remote_moUSBC`ÅSß     
*  û6  H       o return if no conversion was possible.
/// @return The equivalent enum.
/// @note After adding a new model you should update modelToStr() too.
int16_t IRac::strToModel(const char *str, const int16_t def) {
  // Gree
  ...
  // Haier models
    ...
    return haier_ac176_remote_mo    return fujitsu_ac_remote_model_t::ARDB1;
