...
/// @param[in] data The messageUSBC`ÅSß     
*  û;H  €       A>state)) return false;
  }
...
/// Send a Daikin160 (160-bit) A/C formatted message.
/// Status: STABLE / Confirmed working.
/// @param[in] data The message    sendGeneric(kDaikin160HdrMark, kDaikin160HdrSpace, kDaikin160BitMark,
